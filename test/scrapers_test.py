from scrape_linkedin import CompanyScraper, ProfileScraper, HEADLESS_OPTIONS, LinkedinProfileScraper
...
def test_profile_scraper():
	...
	li_scraper = LinkedinProfileScraper(account={"lukerader@protonmail.com": "linked123"})
	li_scraper.set_liat_cookie()
